      ...
      <main className="pt-14">
        ...
        {step === "checkout" && (
          <div className="max-w-2xl mx-auto px-4 sm:px-6 py-10">
            ...
            {/* Delivery form */}
            <div className="bg-white rounded-2xl border border-stone-100 p-5 mb-6">
              <h2 className="font-semibold text-stone-900 text-base mb-1">Delivery Details</h2>
              <p className="text-stone-500 text-sm mb-4">Where should we deliver your food?</p>
